...
public class GameModifyAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		GameModifyRequest req = mapper.readValue(request.getReader(), GameModifyRequest.class);
		
		try {
			int gno = adminService.modifyGame(req);
