			...
			<div class="container">
				...
				<h1>게임 정보 등록</h1><br>
					...
					<div>
						...
						<div class="row" style="margin: 0px;">
						  <input type="text" readonly id="tagnames">  
						</div>
						<br>
						...
						<table>
							...
							<tr>
								<td></td>
								<td><input type="text" id="inputCorp" placeholder="게임사 추가"><input type="button" onclick="registCorp();" value="추가"></td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input name="sprice" style="width: 320px;" type="text"> %
								</td>
							</tr>
							<tr>
								<td>
						...
						<div class="card border-0">
							<div class="card-body" style="width: 800px;">
								...
								<table >
									...
									<tr>
										<td><input type="text" id="" placeholder="프로세서 추가"><input type="button" onclick="registProcessor(this);" value="추가"></td>
										<td></td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td><input type="text" id="" placeholder="그래픽 추가"><input type="button" onclick="registGraphic(this);" value="추가"></td>
										<td></td>
									</tr>
									<tr>
										<td>
...
<div class="container">
  ...
  <%@ include file="gameRegist_js2.jsp" %>
